...
function createTextTexture(gl: any, text: string, font = 'bold 30px Newsreader', color = 'white') {
...
class Title {
  ...
  constructor({ gl, plane, renderer, text, textColor = '#ffffff', font = '30px Newsreader' }: any) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
class Media {
  ...
  onResize({ screen, viewport }: any = {}) {
    ...
    this.scale = isMobile ? this.screen.height / 2000 : this.screen.height / 1500;
...
export default function CircularGallery({
  ...
  useEffect(() => {
    ...
    // Function to resolve CSS variables for Canvas usage
