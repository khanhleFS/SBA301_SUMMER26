...
6. **`components/story-detail-skeleton.tsx`**: Khung xương tải trang chia tách gồm `StoryDetailBannerSkeleton` và `StoryChaptersSkeleton` giúp giao diện không bị xê dịch (Layout Shift) khi tải dữ liệu.
