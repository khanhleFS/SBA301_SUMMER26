...
export default function HomePage() {
  ...
  useEffect(() => {
    // Safety fallback: if WebGL takes too long or fails to load, force page display after 3.5 seconds
  ...
  return (
    <div className="relative pb-5 bg-lumina-surface min-h-screen">
      {/* SKELETON LAYER - absolute overlay with cross-fade */}
      <div 
        className={`absolute inset-x-0 top-0 z-50 bg-lumina-surface pointer-events-none select-none transition-opacity duration-1000 ease-out ${
      ...
      {/* REAL CONTENT LAYER - cross-fade once initialized */}
      <div 
        className={`transition-opacity duration-1000 ease-out ${
          isPageLoaded ? 'opacity-100' : 'opacity-0 pointer-events-none'
        }`}
      >
